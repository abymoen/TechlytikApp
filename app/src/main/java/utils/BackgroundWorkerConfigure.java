...
/**
 * Created by alex on 2016-06-16.
 */
public class BackgroundWorkerConfigure extends AsyncTask<String, Void, String> {

    private Context context;
    private ConfigureMonitorActivity activity;
    public BackgroundWorkerConfigure(Context ctx, ConfigureMonitorActivity act) {
        context = ctx;
        activity = act;
    }
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            URL url = new URL(Constants.CONFIGURE_URL);
            try {
